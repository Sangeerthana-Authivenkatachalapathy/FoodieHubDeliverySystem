    ...
    public class DeliveryPartnerRepository : IDeliveryPartnerRepository
    {
        ...
        public async Task<User?> ValidateCredentialsAsync(string email, string password)
        {
            return await _context.Users
                .FirstOrDefaultAsync(u => u.Email == email && u.PasswordHash == password && u.Role == UserRole.DeliveryPartner);
        }
        ...
        public async Task<bool> ApproveDeliveryPartnerAsync(int userId)
        {
            ...
            if (user == null || user.Role != UserRole.DeliveryPartner) return false;
        ...
        public async Task<IEnumerable<OrderDTO>> GetAssignedOrdersAsync(int deliveryPartnerId)
        {
            return await _context.FoodOrders
                .Where(o => o.DeliveryPartnerId == deliveryPartnerId && o.OrderStatus == OrderStatus.Assigned)
        ...
        //Update Status
        public async Task<bool> UpdateDeliveryStatusAsync(int orderId, OrderStatus status)
        {
            var order = await _context.FoodOrders.FindAsync(orderId);
        ...
        {
            return await _context.FoodOrders
                .Where(o => o.DeliveryPartnerId == deliveryPartnerId && o.OrderStatus == OrderStatus.Delivered)
